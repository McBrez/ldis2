...
HD_PWD='D:/DEV/ldis_task2/_DAFR_/vivado/ldis_task1_DAFR.runs/ldis_task1_bd_SamplingWrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ldis_task1_bd_SamplingWrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ldis_task1_bd_SamplingWrapper_0_0.tcl
