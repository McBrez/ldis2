...
HD_PWD='D:/DEV/ldis_task2/_DAFR_/vivado/ldis_task1_DAFR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ldis_task1_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ldis_task1_bd_wrapper.tcl -notrace
