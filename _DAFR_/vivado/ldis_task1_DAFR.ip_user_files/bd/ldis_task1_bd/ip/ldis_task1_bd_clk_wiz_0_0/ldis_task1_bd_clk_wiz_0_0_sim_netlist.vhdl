...
-- Date        : Sun May 19 13:15:10 2019
-- Host        : FREISMUTHDESK running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/DEV/ldis_task2/_DAFR_/vivado/ldis_task1_DAFR.srcs/sources_1/bd/ldis_task1_bd/ip/ldis_task1_bd_clk_wiz_0_0/ldis_task1_bd_clk_wiz_0_0_sim_netlist.vhdl
-- Design      : ldis_task1_bd_clk_wiz_0_0
...
entity ldis_task1_bd_clk_wiz_0_0_ldis_task1_bd_clk_wiz_0_0_clk_wiz is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of ldis_task1_bd_clk_wiz_0_0_ldis_task1_bd_clk_wiz_0_0_clk_wiz : entity is "ldis_task1_bd_clk_wiz_0_0_clk_wiz";
end ldis_task1_bd_clk_wiz_0_0_ldis_task1_bd_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of ldis_task1_bd_clk_wiz_0_0_ldis_task1_bd_clk_wiz_0_0_clk_wiz is
  signal clk_in1_ldis_task1_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ldis_task1_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_ldis_task1_bd_clk_wiz_0_0_en_clk : STD_LOGIC;
  signal clkfbout_buf_ldis_task1_bd_clk_wiz_0_0 : STD_LOGIC;
  signal clkfbout_ldis_task1_bd_clk_wiz_0_0 : STD_LOGIC;
...
clkf_buf: unisim.vcomponents.BUFG
     port map (
      I => clkfbout_ldis_task1_bd_clk_wiz_0_0,
      O => clkfbout_buf_ldis_task1_bd_clk_wiz_0_0
    );
clkin1_ibufg: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_ldis_task1_bd_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCTRL
    generic map(
      ...
      CE0 => seq_reg1(7),
      CE1 => '0',
      I0 => clk_out1_ldis_task1_bd_clk_wiz_0_0,
      I1 => '1',
      IGNORE0 => '0',
      IGNORE1 => '1',
      O => clk_out1,
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      I => clk_out1_ldis_task1_bd_clk_wiz_0_0,
      O => clk_out1_ldis_task1_bd_clk_wiz_0_0_en_clk
    );
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      STARTUP_WAIT => "FALSE"
        ...
        port map (
      CLKFBIN => clkfbout_buf_ldis_task1_bd_clk_wiz_0_0,
      CLKFBOUT => clkfbout_ldis_task1_bd_clk_wiz_0_0,
      CLKIN1 => clk_in1_ldis_task1_bd_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_out1_ldis_task1_bd_clk_wiz_0_0,
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_ldis_task1_bd_clk_wiz_0_0_en_clk,
      CE => '1',
      D => locked_int,
      Q => seq_reg1(0),
      R => '0'
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ldis_task1_bd_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    clk_in1 : in STD_LOGIC
  );
  attribute NotValidForBitStream : boolean;
  attribute NotValidForBitStream of ldis_task1_bd_clk_wiz_0_0 : entity is true;
end ldis_task1_bd_clk_wiz_0_0;

architecture STRUCTURE of ldis_task1_bd_clk_wiz_0_0 is
begin
inst: entity work.ldis_task1_bd_clk_wiz_0_0_ldis_task1_bd_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1
    );
