...
#
# Generated by export_simulation on Sun May 19 16:42:34 +0200 2019
#
################################################################################
...
'-reset_run' switch to the './ldis_task1_bd.sh' script.

./ldis_task1_bd.sh -reset_run
...
./ldis_task1_bd.sh -noclean_files

For more information on the script, please type './ldis_task1_bd.sh -help'.
